      ...
      <div className="bg-white rounded-2xl border-2 border-slate-200 shadow-lg overflow-hidden">
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <h4 className="text-xl font-black text-slate-700 mb-2">
          ...
          <div className="divide-y divide-slate-200">
            {filteredRequests.map((request, index) => (
              <div
                ...
                className="p-6 hover:bg-slate-50 transition-all duration-300 border-l-4 border-transparent hover:border-amber-400"
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-3">
                      <div
                        className={`px-4 py-2 rounded-full border-2 flex items-center gap-2 font-black text-sm ${getStatusColor(request.status)}`}
                      >
                        {getStatusIcon(request.status)}
                        <span className="uppercase">{request.status}</span>
                      </div>
                      <span className="text-sm text-slate-500 font-semibold">Request #{request.request_id}</span>
                    </div>
                ...
                {request.status === "pending" && (
                  <div className="flex gap-3 mt-4 pt-4 border-t-2 border-slate-200">
                    <button
                      ...
                      className="flex-1 bg-emerald-600 hover:bg-emerald-700 text-white font-black py-3 px-4 rounded-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2 shadow-md hover:shadow-lg"
                    >
                      <CheckCircle size={18} />
                      Accept Request
                    </button>
                    <button
                      ...
                      className="flex-1 bg-red-600 hover:bg-red-700 text-white font-black py-3 px-4 rounded-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2 shadow-md hover:shadow-lg"
                    >
                      <XCircle size={18} />
                      Reject Request
                    </button>
            ...
            <div className="p-6 space-y-6 max-h-[calc(90vh-180px)] overflow-y-auto">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={6}
                  className="w-full px-4 py-3 rounded-lg border-2 border-slate-300 focus:border-amber-400 focus:outline-none transition-all duration-200 font-medium resize-none"
                  disabled={submitting}
                  required
                />
              ...
              <div className="flex gap-3 pt-4 border-t-2 border-slate-200">
                <button
                  onClick={closeResponseModal}
                  className="flex-1 bg-slate-200 hover:bg-slate-300 text-black font-black py-3 px-4 rounded-lg transition-all duration-300"
                  disabled={submitting}
                >
                  Cancel
                </button>
                <button
                  ...
                  } text-white font-black py-3 px-4 rounded-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none shadow-md hover:shadow-lg`}
                >
                  {submitting ? (
                    <>
